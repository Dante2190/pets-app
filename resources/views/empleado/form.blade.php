        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" autocomplete="off" placeholder="Escriba los nombres del empleado" class="form-control"
                        id="nombre" value="{{ isset($empleado->nombre) ? $empleado->nombre : '' }}" name="nombre" required><br>
                </div>
                <div class="form-group">
                    <label for="apellido">Apellido</label>
                    <input type="text" autocomplete="off" placeholder="Escriba los apellidos del empleado" class="form-control"
                        id="apellido" value="{{ isset($empleado->apellido) ? $empleado->apellido : '' }}" name="apellido" required><br>
                </div>
                <div class="form-group">
                ...
                <a class="btn btn-primary" href="{{ url('empleado/') }}"><i class="fa fa-angle-double-left" style="font-size:24px"></i> Regresar</a>
            </div>
        </div>
